/* Wilfrido Varela  10/28/2020
Dr_McMillan     Tarrant County College 
Purpose of this assignment is to practice with functions
Learned how to create a decision program with multiple functions.
*/
...
int main() {
	...
	// do-while is used to loop until "E" or "e is pressed by the user. Exits
	// the program."
	do {
		...
		if (weChoose == "C" ||
			weChoose == "c") // If the user chooses "C" or "c", the motion menu.
		{
			motionMenu();
			...
			chooseMotion(motionInput);
			 ...
			 weChoose != "e"); // DeMorgan's Law is applied here
}
